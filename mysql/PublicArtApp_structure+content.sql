...
--
-- Host: localhost
-- Generation Time: Jan 07, 2015 at 08:50 PM
...
(20, 'Collegium', '', '29.72404700', '-95.34302300', 'William King', '1925', 'Florida', 'Aluminum', 'http://www.williamkingsculptor.com/William_King/Movie.html', '32 feet x 16 feet x 8 feet', '1984', 47000, 'Main', 'Walkway between Communication and Fine Arts Buildings', 0, 0, 'Statue', 'Three, Tall, Men', 'White, Metal', 'Contemporary Art', 'King’s sculptures are both humorous and intuitive, derived from his observation of life experience In developing his ideas, King usually makes maquettes (a small scale model unfinished architectural work or a sculpture), cut like paper dolls from white index cards. Simplicity of sculpture describes caricatures of people in daily activities.', 'williamking.png', 'Holding hands, Central, Tall'),
(21, 'Genki', '', '29.71826500', '-95.34445300', 'Denise Kroneman', '1952', 'New York', 'Cement, mirror and ceramic tile', '', '', '2005', 3500, 'Main', 'Justin Dart Center for Students with DisABILITIES', 0, 0, 'Sculpture', 'Abstract', 'Red, White', 'Contemporary Art', '', 'denisekroneman.png', 'Hole yellow, Residential, Texas, Houston, Tile'),
...
INSERT INTO `tours` (`tour_id`, `artwork_included`, `predefined`, `times_taken`, `likes`, `estimated_time`, `estimated_distance`, `tour_title`, `picture`, `creator`, `date_created`, `artistic_attributes`) VALUES
(1, '5,6,17,28,34,35', NULL, 0, NULL, NULL, NULL, 'New Acquisitions', NULL, 'Mike', '2014-07-23', 'Art from 2012'),
(2, '4,8,20,30,31,38', NULL, 0, NULL, NULL, NULL, 'Arts', NULL, 'Mike', '2014-07-23', 'Precint'),
(3, '12,26', NULL, 0, NULL, NULL, NULL, 'Athletics', NULL, 'Mike', '2014-07-28', 'Precint'),
(4, '3,7,11,18,19,24,25,27,29', NULL, 0, NULL, NULL, NULL, 'Central', NULL, 'Mike', '2014-07-23', 'Precint'),
(5, '2,9,22,23', NULL, 0, NULL, NULL, NULL, 'Professional', NULL, 'Mike', '2014-07-23', 'Precint'),
(6, '6,10,17,21,32,33', NULL, 0, NULL, NULL, NULL, 'Residential', NULL, 'Mike', '2014-07-23', 'Precint'),
(7, '14,15', NULL, 0, NULL, NULL, NULL, 'Cullen North', NULL, 'Mike', '2014-07-28', 'Precint'),
(8, '5,13,16', NULL, 0, NULL, NULL, NULL, 'Biomedical', NULL, 'Mike', '2014-07-25', 'Precint');
...
--
ALTER TABLE `tours`
 ADD PRIMARY KEY (`tour_id`), ADD KEY `predefined` (`predefined`,`times_taken`,`likes`,`estimated_time`,`estimated_distance`), ADD KEY `tour_title` (`tour_title`), ADD KEY `tour_author` (`creator`,`date_created`), ADD KEY `artistic_attributes` (`artistic_attributes`(255));
